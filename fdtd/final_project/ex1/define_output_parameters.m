...
sampled_voltages(1).min_x = 40e-3;
sampled_voltages(1).min_y = 40e-3;
sampled_voltages(1).min_z = 4e-3;
sampled_voltages(1).max_x = 45e-3;
sampled_voltages(1).max_y = 45e-3;
sampled_voltages(1).max_z = 6e-3;

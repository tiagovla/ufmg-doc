...
sampled_voltages(1).min_x = 8.0e-3;
sampled_voltages(1).min_y = 1.0e-3;
sampled_voltages(1).min_z = 0;
sampled_voltages(1).max_x = 8.0e-3;
...
% define sampled voltages
% sampled_voltages(2).min_x = 8.0e-3;
% sampled_voltages(2).min_y = 1.0e-3;
% sampled_voltages(2).min_z = 0;
% sampled_voltages(2).max_x = 8.0e-3;
% sampled_voltages(2).max_y = 1.0e-3;
% sampled_voltages(2).max_z = 2.0e-3;
...
% sampled_currents(1).min_z = 2.0e-3;
% sampled_currents(1).max_x = 5.0e-3;
% sampled_currents(1).max_y = 2.0e-3;
% sampled_currents(1).max_z = 2.0e-3;
